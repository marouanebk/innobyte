...
export default function Sidebar() {
  ...
  //     <div key={attribute}>
  //       <div className="flex justify-between buttonStyle3 p-2 my-2">
  //         <h3 className="font-bold my-1">{attribute}</h3>
  //         <button
  //           onClick={() => toggleMenu(attribute)}
  //           aria-controls="model"
  //           aria-expanded={isOpen[attribute]}
  //           type="button"
  //           className="buttonStyle3 z-30 flex items-center justify-center cursor-pointer group focus:outline-none"
  //           data-carousel-prev
  //         >
